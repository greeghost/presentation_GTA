...
\begin{frame}{A truthful approximation mechanism}
    \begin{columns}
        \column{0.6\textwidth}
        % Oracle that can be computed in polynomial time \(\Rightarrow\) LP of exponetial size can be solved in polynomial time

        % Set of feasable integral solutions
...
\begin{frame}{Conclusion}
    \begin{columns}
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                \item First work on auctions with complements
